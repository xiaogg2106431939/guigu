<template>
  <div class="detail">
    ...
    <!-- 主要内容区域 -->
    <section class="con">
      <!-- 导航路径区域  报Cannot read properties of undefined (reading 'category1Name')" 解决：v-if="categoryView" 或 || {}-->
      <div class="conPoin">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd :class="{active:saleAttrSon.isChecked==1}" v-for="saleAttrSon in saleAttr.spuSaleAttrValueList" :key="saleAttrSon.id" @click="changeAttr(saleAttrSon,saleAttr.spuSaleAttrValueList)">{{saleAttrSon.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
